...
docker-compose exec proxy $1 /var/www/html/db_sync_tool -f /var/www/html/tests/scenario/link/sync-www1-to-www2.json -y -o /var/www/html/tests/scenario/link/hosts.json $2
