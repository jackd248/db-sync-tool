...
docker-compose exec www2 python3 /var/www/html/db_sync_tool -f /var/www/html/tests/scenario/import_remote/import-www1-from-local.json -y -i /var/www/html/tests/files/www1/database_backup/test.sql $1
