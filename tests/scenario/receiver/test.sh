...
printf "\033[94m[TEST]\033[m Sync mode: RECEIVER"
printf " \033[90m(Sync: WWW1 -> WWW2, Initiator: WWW2)\033[m"
docker-compose exec www2 python3 /var/www/html/db_sync_tool -f /var/www/html/tests/scenario/receiver/sync-www1-to-local.json -y $1
