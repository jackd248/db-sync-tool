...
docker-compose exec www2 python3 /var/www/html/db_sync_tool -f /var/www/html/tests/scenario/import_local/import-local.json -i /var/www/html/tests/files/www2/database_backup/test.sql $1
