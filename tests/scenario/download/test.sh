...
docker-compose exec www2 python3 /var/www/html/db_sync_tool -f /var/www/html/tests/scenario/download/sync-www1-to-local.json -m -kd /var/www/html/tests/files/www2/download/ -dn dump
